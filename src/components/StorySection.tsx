...
const values = [
  {
    icon: Leaf,
    title: "産地への敬意",
    description: "コーヒーの産地を訪れ、生産者と直接対話しながら豆を選びます。フェアな取引と持続可能な農業を支援しています。",
  },
  {
    icon: Heart,
    title: "丁寧な焙煎",
    description: "少量ずつ、豆の個性を最大限に引き出す焙煎プロファイルで仕上げます。注文後に焙煎することで、常に新鮮な状態でお届けします。",
  },
  {
    icon: Star,
    title: "簡単・美味しい",
    description: "ドリップバッグだから、特別な器具は不要。マグカップにセットしてお湯を注ぐだけで、カフェクオリティのコーヒーが楽しめます。",
  },
];
        ...
        <div className="grid gap-16 md:grid-cols-2 md:items-center">
          ...
          <div>
            ...
            <p className="mb-8 leading-relaxed text-muted-foreground">
              忙しい朝でも、旅先でも、どこにいても本格的なコーヒーを
              楽しんでほしい——そんな想いからドリップバッグという形を選びました。
            </p>
          ...
          <div className="relative">
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, oklch(0.60 0.09 162 / 0.15) 0%, oklch(0.42 0.13 310 / 0.15) 100%)",
              }}
            >
              {/* Decorative elements */}
              <div className="absolute inset-8 flex flex-col items-center justify-center gap-6 text-center">
                ...
                <blockquote className="text-lg font-semibold italic leading-relaxed text-foreground/70">
                  &ldquo;Good coffee is a pleasure.
                  <br />
                  Good friends are a treasure.&rdquo;
                </blockquote>
                <div
                  className="h-px w-16"
            ...
            {/* Floating badge */}
            <div
              className="absolute -right-4 -top-4 flex flex-col items-center justify-center rounded-2xl px-4 py-3 text-center shadow-md"
              style={{ background: "#693c85", color: "white" }}
            >
